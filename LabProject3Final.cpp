...
void city()
{
    ...
    circle(30,30,o-740, 470);
    circle(30,30,o-755, 480);
    circle(30,30,o-770, 475);
    circle(30,30,o-720, 480);
    circle(30,30,o-750, 500);
    ...
    glVertex3f(500.0f, 050.0f, 0.0f);
    glVertex3f(450.0f, 050.0f, 0.0f);
    glVertex3f(450.0f, 335.0f, 0.0f);
    glVertex3f(500.0f, 335.0f, 0.0f);

    glColor3f (0.4, 0.4, 0.8);
    glVertex3f(500.0f, 50.0f, 0.0f);
    glVertex3f(500.0f, 335.0f, 0.0f);    
    glVertex3f(560.0f, 258.f, 0.0f);
    glVertex3f(560.0f, 70.f, 0.0f);

    //5th building windows
    glColor3f (1.0, 1.0, 1.0);
    glVertex3f(460.0f, 060.0f, 0.0f);
    glVertex3f(490.0f, 060.0f, 0.0f);
    glVertex3f(490.0f, 100.0f, 0.0f);
    glVertex3f(460.0f, 100.0f, 0.0f);

    glColor3f (1.0, 1.0, 1.0);
    glVertex3f(460.0f, 130.0f, 0.0f);
    glVertex3f(490.0f, 130.0f, 0.0f);
    glVertex3f(490.0f, 170.0f, 0.0f);
    glVertex3f(460.0f, 170.0f, 0.0f);

    glColor3f (1.0, 1.0, 1.0);
    glVertex3f(460.0f, 200.0f, 0.0f);
    glVertex3f(490.0f, 200.0f, 0.0f);
    glVertex3f(490.0f, 240.0f, 0.0f);
    glVertex3f(460.0f, 240.0f, 0.0f);

    glColor3f (1.0, 1.0, 1.0);
    glVertex3f(460.0f, 270.0f, 0.0f);
    glVertex3f(490.0f, 270.0f, 0.0f);
    glVertex3f(490.0f, 310.0f, 0.0f);
    glVertex3f(460.0f, 310.0f, 0.0f);
    ...
    glVertex3f(450.0f, 050.0f, 0.0f);
    glVertex3f(500.0f, 050.0f, 0.0f);
    glVertex3f(500.0f, 040.0f, 0.0f);

    glColor3f (0.0, 0.0, 0.0);
    glVertex3f(500.0f, 040.0f, 0.0f);
    glVertex3f(500.0f, 050.0f, 0.0f);
    glVertex3f(560.0f, 070.0f, 0.0f);
    glVertex3f(560.0f, 060.0f, 0.0f);
    ...
    glVertex3f( 450.0f, 100.0f, 0.0f);
    glVertex3f( 350.0f, 100.0f, 0.0f);

    glVertex3f( 450.0f, 160.0f, 0.0f);
    glVertex3f( 350.0f, 160.0f, 0.0f);

    glVertex3f( 450.0f, 210.0f, 0.0f);
    glVertex3f( 350.0f, 210.0f, 0.0f);

    //5th building sideline
    glColor3f(0.0 ,0.0,0.0);
    glVertex3f( 450.0f, 333.0f ,0.0f );
    glVertex3f( 450.0f, 050.0f ,0.0f );

    glVertex3f( 500.0f, 333.0f ,0.0f );
    glVertex3f( 500.0f, 050.0f ,0.0f );
    ...
    glVertex3f( 500.0f, 115.0f ,0.0f );

    glVertex3f( 450.0f, 185.0f ,0.0f );
    glVertex3f( 500.0f, 185.0f ,0.0f );

    glVertex3f( 450.0f, 255.0f ,0.0f );
    glVertex3f( 500.0f, 255.0f ,0.0f );

    //5th building right side
    glVertex3f( 500.0f, 333.0f ,0.0f );
    glVertex3f( 560.0f, 258.0f ,0.0f );

    glVertex3f( 500.0f, 255.0f ,0.0f );
    glVertex3f( 560.0f, 210.0f ,0.0f );

    glVertex3f( 500.0f, 185.0f ,0.0f );
    glVertex3f( 560.0f, 160.0f ,0.0f );

    glVertex3f( 500.0f, 115.0f ,0.0f );
    glVertex3f( 560.0f, 110.0f ,0.0f );
